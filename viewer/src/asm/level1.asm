...
map0:
	...
	.word	tile_calcRaster(0)	.byte	LIGHT_BLUE 	.byte 0
	.word	tile_calcRaster(1)	.byte	LIGHT_GREEN	.byte 0
	.word	tile_calcRaster(2)	.byte	LIGHT_RED	.byte 0
	.word	$0000				.byte	$FF			.byte 0	// end of color switch table
